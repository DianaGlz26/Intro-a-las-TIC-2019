			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-copy"></i> <span>Formularios</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Formularios">
								<li class="nav-item"><a href="file:///C:/Users/MA%20Reyes%20Buenrostro/Desktop/UPV/PRIMER%20CUATRIMESTRE/Introducci%C3%B3n%20a%20las%20TI/Bootstrap%204/Template/layout_1/LTR/default/full/Formulario%20Alumnos.html?gender=on#" class="nav-link active">Agregar alumno</a></li>
								<li class="nav-item"><a href="../../../../layout_2/LTR/default/full/index.html" class="nav-link">Agregar maestro</a></li>
								<!--<li class="nav-item"><a href="../../../../layout_3/LTR/default/full/index.html" class="nav-link">Listado de alumnos</a></li> -->
							</ul>
						</li>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_layout_horizontal.html" class="breadcrumb-item">Formularios</a>
							...
							<div class="card-body">
								<form action="#">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" minlength="7" maxlength="7" required pattern="[0-9]+">
										</div>
									</div>

				...
				<!-- Marketing campaigns -->
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Flujo de estudiantes por carrera</h6>
								<div class="header-elements">
									<span class="badge bg-success badge-pill">Online</span>
									<div class="list-icons ml-3">
				                		<div class="list-icons-item dropdown">
				                			<a href="#" class="list-icons-item dropdown-toggle" data-toggle="dropdown"><i class="icon-menu7"></i></a>
											<div class="dropdown-menu">
												<a href="#" class="dropdown-item"><i class="icon-sync"></i> Actuaizar información</a>
							...
							<div class="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
								<div class="d-flex align-items-center mb-3 mb-sm-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">ITI <span class="text-success font-size-sm font-weight-normal"><i class="icon-arrow-up12"></i> (+97.72%)</span></h5>
										<span class="badge badge-mark border-success mr-1"></span> <span class="text-muted">Oct 14, 17:28</span>
									</div>
								</div>
								...
								<div class="d-flex align-items-center mb-3 mb-sm-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">PYMES <span class="text-danger font-size-sm font-weight-normal"><i class="icon-arrow-down12"></i> (92.63%)</span></h5>
										<span class="badge badge-mark border-danger mr-1"></span> <span class="text-muted">Oct 14, 17:28</span>
									</div>
								</div>

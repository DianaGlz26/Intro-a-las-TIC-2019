				...
				<div class="row">
					...
					<div class="card">
							<div class="card-header header-elements-inline">
								...
								<div class="header-elements">
									<span><i class="icon-history text-warning mr-2"></i> Oct 14, 16:30</span>
							...
							<div class="card-body pb-0">
								<div class="row text-center">
									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">200</h5>
									...
									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">4,750</h5>
											<span class="text-muted font-size-sm">Todos los alumnos</span>
										</div>
									</div>
								</div>
							</div>

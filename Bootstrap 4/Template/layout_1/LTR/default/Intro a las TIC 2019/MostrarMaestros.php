	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Maestros</span> - Mostrar maestros</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_layout_horizontal.html" class="breadcrumb-item">Maestros</a>
							<span class="breadcrumb-item active">Mostrar maestros</span>
						</div>
			...
			<div class="content">
				...
				<button class="btn btn-success" data-toggle="modal" data-target="#modalDos">Editar maestro</button>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 id="tituloVentana">Editar maestro</h5>
											...
											<div class="alert alert-success">
												<div class="form-group row">
										           <label class="col-lg-3 col-form-label">Buscar:</label>
										            <div class="col-lg-9">
											            <input type="text" class="form-control" required pattern="[A-Za-z0-9]+" placeholder="Nombre, apellido o clave de profesor" maxlength="30">
											            <br>
											            ...
											            <form action="#">
											            	...
											            	<div class="form-group row">
											            		...
											            		<div class="col-lg-9">
											            			<select class="form-control form-control-select2" data-fouc>
											            				<option value="IP">Introducción a la programación</option>
											            				<option value="HO">Herramientas ofimáticas</option>
											            				<option value="AL">Álgebra lineal</option>
											            				<option value="QB">Química básica</option>
											            				<option value="TICS">Introducción a las TIC'S</option>
											            			</select>
											            		</div>
											            	</div>
				...
				<!-- /basic datatable -->
						...
						<!-- Today's revenue -->
								<div class="card bg-blue-400">
									<div class="card-body">
										<div class="d-flex">
											<h3 class="font-weight-semibold mb-0">76.9%</h3>

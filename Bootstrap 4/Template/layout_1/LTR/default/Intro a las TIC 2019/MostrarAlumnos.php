	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Alumnos</span> - Mostrar alumnos</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Mostrar alumnos</span>
						</div>
			...
			<div class="content">
				...
				<button class="btn btn-success" data-toggle="modal" data-target="#modalUno">Editar alumno</button>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 id="tituloVentana">Editar alumno</h5>
											...
											<div class="alert alert-success">
												<div class="form-group row">
										           <label class="col-lg-3 col-form-label">Buscar:</label>
										            <div class="col-lg-9">
											            <input type="text" class="form-control" required pattern="[A-Za-z0-9]+" placeholder="Nombre, apellido o matrícula" maxlength="30">
											            <br>
											            		...
											            		<div class="col-lg-9">
											            			<div class="form-check form-check-inline">
											            				<label class="form-check-label">
											            					<input type="radio" class="form-input-styled" name="gender" checked data-fouc>Masculino
											            				</label>
											            			</div>
											            	...
											            	<div class="form-group row">
											            		...
											            		<div class="col-lg-9">
											            			<div class="row">
											            				<div class="col-md-6">
											            					<div class="mb-3">
											            						<select data-placeholder="País" class="form-control form-control-select2" data-fouc>
											            							<option></option>
				...
				<!-- Latest posts -->
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Ediciones recientes</h6>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
								...
								<div class="row">
									<div class="col-xl-6">
										<div class="media flex-column flex-sm-row mt-0 mb-3">
				        					...
				        					<div class="media-body">
												<h6 class="media-title"><a href="#">1111103</a></h6>
					                    		<ul class="list-inline list-inline-dotted text-muted mb-2">
					                    			<li class="list-inline-item"><i class="icon-book-play mr-2"></i> América Barrón</li>
					                    		</ul>
												PYMES
												1111103@upv.edu.mx
											</div>
										...
										<div class="media flex-column flex-sm-row mt-0 mb-3">
				        					...
				        					<div class="media-body">
												<h6 class="media-title"><a href="#">1111110</a></h6>
					                    		<ul class="list-inline list-inline-dotted text-muted mb-2">
					                    			<li class="list-inline-item"><i class="icon-book-play mr-2"></i> Olinda Pérez</li>
					                    		</ul>
												MANU
												1111110@upv.edu.mx
											</div>
									...
									<div class="col-xl-6">
										<div class="media flex-column flex-sm-row mt-0 mb-3">
				        					...
				        					<div class="media-body">
												<h6 class="media-title"><a href="#">1111101</a></h6>
					                    		<ul class="list-inline list-inline-dotted text-muted mb-2">
					                    			<li class="list-inline-item"><i class="icon-book-play mr-2"></i> Paulina Rodríguez</li>
					                    		</ul>
												ITI
												1111101@upv.edu.mx
											</div>
										...
										<div class="media flex-column flex-sm-row mt-0 mb-3">
				        					...
				        					<div class="media-body">
												<h6 class="media-title"><a href="#">1111104</a></h6>
					                    		<ul class="list-inline list-inline-dotted text-muted mb-2">
					                    			<li class="list-inline-item"><i class="icon-book-play mr-2"></i> Carlos Domínguez</li>
					                    		</ul>
												MECA
												1111104@upv.edu.mx
											</div>

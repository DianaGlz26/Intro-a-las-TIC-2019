			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Maestros</span> - Agregar maestro</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Agregar maestro</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					...
					<!-- Traffic sources -->
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Maestros registrados</h6>
								<div class="header-elements">
								...
								<div class="row">
									<div class="col-sm-4">
										<div class="d-flex align-items-center justify-content-center mb-2">
											...
											<div>
												<div class="font-weight-semibold">Recientemente</div>
									...
									<div class="col-sm-4">
										<div class="d-flex align-items-center justify-content-center mb-2">
											...
											<div>
												<div class="font-weight-semibold">Puntualidad</div>
												<span class="text-muted">98.89%</span>
											</div>
										</div>
									...
									<div class="col-sm-4">
										<div class="d-flex align-items-center justify-content-center mb-2">
											...
											<div>
												...
												<span class="text-muted"><span class="badge badge-mark border-success mr-2"></span> 37</span>
											</div>
										</div>

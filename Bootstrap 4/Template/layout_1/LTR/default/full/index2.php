				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Materias">
								<li class="nav-item"><a href="" class="nav-link">Agregar tutoría</a></li>
								<li class="nav-item"><a href="" class="nav-link">Listado de tutorías</a></li>
					...
					<div class="col-xl-7">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Alumnos registrados</h6>
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="d-flex align-items-center justify-content-center mb-2">
											...
											<div>
												<div class="font-weight-semibold">Ayer</div>
									...
									<div class="col-sm-4">
										<div class="d-flex align-items-center justify-content-center mb-2">
											...
											<div>
												...
												<span class="text-muted"><span class="badge badge-mark border-success mr-2"></span>1,620</span>
											</div>
										</div>
						...
						<div class="row">
							<div class="col-lg-4">
								...
								<div class="card bg-teal-400">
									<div class="card-body">
										<div class="d-flex">
											<h3 class="font-weight-semibold mb-0">ITI</h3>
											<span class="badge bg-teal-800 badge-pill align-self-center ml-auto">+50,0%</span>
					                	</div>
					                	
					                	<div>
											Carrera con mayor porcentaje en asesorías
											<div class="font-size-sm opacity-75">5/10 tutorías</div>
										</div>
									</div>
							...
							<div class="col-lg-4">
								...
								<!-- Alumnos en tutoria actualmente-->
								<div class="card bg-pink-400">
									<div class="card-body">
											...
											<div class="list-icons ml-auto">
						                		<div class="list-icons-item dropdown">
													...
													<div class="dropdown-menu dropdown-menu-right">
														...
														<a href="#" class="dropdown-item"><i class="icon-list-unordered"></i> Más información</a>
													</div>
						                		</div>
					                		</div>
					                	</div>
					                	...
					                	<div>
											Alumnos en tutoría actualmente
											<div class="font-size-sm opacity-75">20.0%</div>
										</div>
									</div>

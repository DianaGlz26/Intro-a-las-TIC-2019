			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Transporte</span> - Agregar transprte</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_layout_horizontal.html" class="breadcrumb-item">Transporte</a>
							<span class="breadcrumb-item active">Agregar transporte</span>
						</div>
							...
							<div class="card-body">
								<form action="#">
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Nombre del alumno:</label>
										<div class="col-lg-9">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<select class="form-control form-control-select2" data-fouc>
													...
													<option value="TAM">Tamatán</option>
													<option value="LIB">Libertad</option>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<select class="form-control form-control-select2" data-fouc>
													...
													<option value="am">7:00 am</option>
													<option value="pm">9:00 pm</option>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" required pattern="[0-9]+" placeholder="15/10/2019" minlength="11" maxlength="11">
										</div>
									</div>

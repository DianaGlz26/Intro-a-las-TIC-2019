			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Maestros</span> - Editar maestro</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Editar maestro</span>
						</div>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="card">
							...
							<button class="btn btn-success" data-toggle="modal" data-target="#ventanaModal">Buscar</button>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 id="tituloVentana">Buscar maestro</h5>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<select class="form-control form-control-select2" data-fouc>
													...
													<option value="L1">Expresión oral y escrita 1</option>
											...
											<div class="col-lg-9">
												<div class="row">
													<div class="col-md-6">
							                            ...
							                            <input type="text" placeholder="Código postal" class="form-control" required pattern="[0-9]+" minlength="5" maxlength="5">
													</div>
